...
export const translations = {
  en: {
    ...
    exchangeOnboardingTitle: 'Connect Your Exchange',
    exchangeOnboardingSubtitle:
      'Before trading, link your exchange API keys. Credentials are encrypted before transmission.',
    exchangeOnboardingStepSelect: 'Choose exchange',
    exchangeOnboardingStepKeys: 'Enter API keys',
    exchangeOnboardingStepTest: 'Test connection',
    exchangeOnboardingSecurityNote:
      'API keys are encrypted in your browser before upload. Never grant withdrawal permissions.',
    exchangeOnboardingSkip: 'Set up later',
    exchangeOnboardingGoTraders: 'Go to AI Traders page',
    exchangeOnboardingComplete: 'Exchange connected successfully',
    savingExchangeConfig: 'Saving exchange configuration…',
    exchangeConfigSaved: 'Exchange configuration saved',
  ...
  zh: {
    ...
    exchangeOnboardingTitle: '连接您的交易所',
    exchangeOnboardingSubtitle:
      '开始交易前，请先配置交易所 API。凭证将在浏览器中加密后上传。',
    exchangeOnboardingStepSelect: '选择交易所',
    exchangeOnboardingStepKeys: '填写 API Key',
    exchangeOnboardingStepTest: '测试连接',
    exchangeOnboardingSecurityNote:
      'API 密钥在浏览器端加密后传输，请勿授予提现权限。',
    exchangeOnboardingSkip: '稍后配置',
    exchangeOnboardingGoTraders: '前往 AI 交易员页面',
    exchangeOnboardingComplete: '交易所已成功连接',
    savingExchangeConfig: '正在保存交易所配置…',
    exchangeConfigSaved: '交易所配置已保存',
